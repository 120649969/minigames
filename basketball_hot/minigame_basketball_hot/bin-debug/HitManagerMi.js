...
var HitManagerMi = (function () {
    function HitManagerMi(_mainPanel) {
        this._isOnFloor = false;
        this._hitType = HitType.None;
        this._isCurrentHitNeedCheck = false;
        this.mainPanel = _mainPanel;
    }
    HitManagerMi.prototype.IsOnFloor = function () {
        return this._isOnFloor;
    };
    HitManagerMi.prototype.GetHitType = function () {
        return this._hitType;
    };
    HitManagerMi.prototype.CheckHit = function () {
        this._hitType = HitType.None;
    ...
    HitManagerMi.prototype.HandleBallHit = function (localBallHitPoint, hitType) {
    ...
    HitManagerMi.prototype.CheckHitRightLine = function () {
        ...
        var is_top = global_ball_center_point.y < right_line_right_point.y;
        if (is_top) {
    ...
    HitManagerMi.prototype.CheckLeftLine = function () {
        var global_ball_left_top_point = new egret.Point();
        this.mainPanel.m_basket_ball.localToGlobal(0, 0, global_ball_left_top_point);
        var global_ball_right_down_point = new egret.Point();
        this.mainPanel.m_basket_ball.localToGlobal(this.mainPanel.m_basket_ball.width, this.mainPanel.m_basket_ball.width, global_ball_right_down_point);
    ...
    HitManagerMi.prototype.CheckHitBoard = function () {
        var global_ball_left_top_point = new egret.Point();
        this.mainPanel.m_basket_ball.localToGlobal(0, 0, global_ball_left_top_point);
        var global_ball_right_down_point = new egret.Point();
        this.mainPanel.m_basket_ball.localToGlobal(this.mainPanel.m_basket_ball.width, this.mainPanel.m_basket_ball.width, global_ball_right_down_point);
    ...
    HitManagerMi.prototype.SetCurrentHitNeedCheck = function (need_check) {
        this._isCurrentHitNeedCheck = need_check;
    };
    HitManagerMi.prototype.IsCurrentHitNeedCheck = function () {
        return this._isCurrentHitNeedCheck;
    };
    return HitManagerMi;
}());
__reflect(HitManagerMi.prototype, "HitManagerMi");
//# sourceMappingURL=HitManagerMi.js.map