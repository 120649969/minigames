window.skins={};
	...
	function MainScene() {
		_super.call(this);
		this.skinParts = ["m_bg","m_floor","m_board_scope","m_net_scope","m_right_line","m_left_line","m_circle_scope","m_basket_container","m_top","m_image_ball","m_basket_ball","btn_debug","m_container"];
	...
	_proto.m_container_i = function () {
		...
		t.width = 640;
		t.elementsContent = [this.m_bg_i(),this.m_floor_i(),this.m_basket_container_i(),this.m_top_i(),this.m_basket_ball_i(),this.btn_debug_i()];
		return t;
	};
	...
	_proto.m_basket_container_i = function () {
		var t = new eui.Group();
		this.m_basket_container = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 569;
		t.height = 1138;
		t.scaleX = 0.4;
		...
		t.width = 640;
		t.x = 0;
		t.elementsContent = [this._Image1_i(),this._Image2_i(),this._Image3_i(),this._Image4_i(),this.m_board_scope_i(),this.m_net_scope_i(),this.m_right_line_i(),this.m_left_line_i(),this.m_circle_scope_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
