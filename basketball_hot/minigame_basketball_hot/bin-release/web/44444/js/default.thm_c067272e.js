window.skins={};
	...
	function MainScene() {
		_super.call(this);
		this.skinParts = ["m_bg","m_floor","m_board_scope","m_left_line","m_circle_scope","m_net_scope","m_right_line","m_board_top_circle","m_board_down_circle","m_basket_container_back","m_top","m_image_ball","m_basket_ball","m_basket_container_pre","btn_debug","m_container"];
	...
	_proto.m_basket_container_back_i = function () {
		...
		t.width = 640;
		t.x = 0;
		t.elementsContent = [this._Image1_i(),this._Image2_i(),this._Image3_i(),this.m_board_scope_i(),this.m_left_line_i(),this.m_circle_scope_i(),this.m_net_scope_i(),this.m_right_line_i(),this.m_board_top_circle_i(),this.m_board_down_circle_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	_proto.m_board_top_circle_i = function () {
		var t = new eui.Group();
		this.m_board_top_circle = t;
		t.height = 20;
		t.width = 20;
		t.x = 41.43;
		t.y = 278;
	...
	_proto.m_board_down_circle_i = function () {
		var t = new eui.Group();
		this.m_board_down_circle = t;
		t.height = 20;
		t.width = 20;
		t.x = 41.43;
		t.y = 536;
